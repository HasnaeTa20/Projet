...
import 'package:projet_pfe/widget/rightBar.dart';
                   ...
                   child: Container(
                    ...
                    children: [
                      ...
                      Color.fromARGB(255, 255, 255, 255),
                       ...
                       child: TextButton(
                          onPressed: () { 
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const Corpus()));
                            },     
                          style: ButtonStyle(
                       ...
                       Expanded(child: Padding(
                        ...
                        child: TextButton(
                        onPressed: () { 
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const ListingCorpus()));          
                              },
                        style: ButtonStyle(
                        foregroundColor: MaterialStateProperty.resolveWith<Color>(
                        (Set<MaterialState> states) {
